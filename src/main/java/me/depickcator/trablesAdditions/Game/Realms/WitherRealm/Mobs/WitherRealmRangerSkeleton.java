...
//        this.equipment(EquipmentSlot.Mob.getEquipmentForSlot(EquipmentSlot.HEAD, random.nextInt(4));
    ...
    public void performRangedAttack(LivingEntity target, float distanceFactor) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            Vec3 direction = (new Vec3(d, d1, d2)).normalize();
    ...
    public Component getMobName() {
        return Component.literal("Dungeon Skeleton").setStyle(Style.EMPTY.withColor(TextColor.fromRgb(TextUtil.GREEN.value())));
    }
}
