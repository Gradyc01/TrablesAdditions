...
public class StartingNPC implements EntityInteractable {
    ...
    private LivingEntity initEntity() {
        ...
        try {
            ...
            forceLoadChunk(spawnLocation,true);
    ...
    public void removeEntity() {
        ...
        forceLoadChunk(entity.getLocation(),false);
        entity.remove();
    }

    private void forceLoadChunk(Location spawnLocation, boolean force) {
        spawnLocation.getWorld().setChunkForceLoaded(spawnLocation.getBlockX()/16, spawnLocation.getBlockZ()/16, force);
    }
}
